...
class EssentialFeedsApiEndToEndTests: XCTestCase {
    ...
    func test_endToEndServerGetFeedResults_matchesFixedTestAccountData(){
        ...
        case let .success(imageFeed):
            XCTAssertEqual(imageFeed.count, 8, "Expected 8 image in the test account imageFeed")
    ...
    private func getFeedResults(file:StaticString = #filePath, line:UInt = #line) -> FeedLoader.Result?{
